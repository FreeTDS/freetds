...
main(void)
{
	...
	test("NotExistingServer1:1234", "NotExistingServer1:1234,8.7.6.5,,1234");
	test("localhost:1234", "localhost:1234,localhost,,1234");
	test("NotExistingServer1\\named", "NotExistingServer1\\named,8.7.6.5,named,0");
	test("localhost\\named", "localhost\\named,localhost,named,0");
