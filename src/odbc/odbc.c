...
TDS_RCSID(var, "$Id: odbc.c,v 1.402.2.7 2009-02-23 16:15:46 freddy77 Exp $");
...
SQLParamOptions(SQLHSTMT hstmt, SQLULEN crow, SQLULEN FAR * pirow)
{
	...
	if (res != SQL_SUCCESS)
		return res;
	/* crow is converted back to SQLINTEGER in _SQLSetStmtAttr so the TDS_INTPTR cast is safe */
