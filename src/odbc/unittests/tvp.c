...
TestTVPInsert(void)
{
	...
	odbc_command("DROP TYPE IF EXISTS TVPType");
	odbc_command("DROP TABLE IF EXISTS TVPTable");
...
TestTVPInsert2(void)
{
	...
	odbc_command("DROP TYPE IF EXISTS TVPType2");
	odbc_command("DROP TABLE IF EXISTS TVPTable2");
