...
static char rcsid_tds_h[] = "$Id: tds.h,v 1.167.2.2 2004-09-16 11:31:47 freddy77 Exp $";
...
TDSICONVINFO *tds_iconv_from_collate(TDSSOCKET * tds, int sql_collate, int lcid);
