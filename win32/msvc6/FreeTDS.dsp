...
# ADD CPP /nologo /MD /W3 /GX /O2 /I ".." /I "../../include" /D "NOCRYPT" /D "HAVE_CONFIG_H" /D "UNIXODBC" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "FREETDS_EXPORTS" /D "HAVE_SQLGETPRIVATEPROFILESTRING" /D "DLL_EXPORT" /YX /FD /c
...
# ADD CPP /nologo /MTd /W3 /Gm /GX /ZI /Od /I ".." /I "../../include" /D "NOCRYPT" /D "HAVE_CONFIG_H" /D "UNIXODBC" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "FREETDS_EXPORTS" /D "HAVE_SQLGETPRIVATEPROFILESTRING" /D "DLL_EXPORT" /FR /FD /GZ /c
# SUBTRACT CPP /YX
