...
# ADD CPP /nologo /MD /W3 /GX /O2 /I ".." /I "../../include" /D "UNIXODBC" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "FREETDS_EXPORTS" /D "HAVE_SQLGETPRIVATEPROFILESTRING" /D "NDEBUG" /D "_LIB" /YX /FD /c
...
# ADD CPP /nologo /MTd /W3 /Gm /GX /ZI /Od /I ".." /I "../../include" /D "UNIXODBC" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "FREETDS_EXPORTS" /D "HAVE_SQLGETPRIVATEPROFILESTRING" /D "_DEBUG" /D "_LIB" /YX /FD /GZ /c
